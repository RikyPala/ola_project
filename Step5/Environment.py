        ...
        for _ in range(daily_users):
            ...
            while to_visit:
                ...
                if secondary_1 not in visited and secondary_1 not in to_visit:
                    ...
                    if np.random.binomial(1, self.graph_probabilities[user_type, current_product, secondary_1]):
                ...
                if secondary_2 not in visited and secondary_2 not in to_visit:
                    ...
                    if np.random.binomial(1, self.lambda_p * self.graph_probabilities[user_type, current_product, secondary_2]):
